...
export const Resources = {
  ...
  TowerLevel1: new ImageSource('./images/tower-level-1.png'),
  TowerLevel2: new ImageSource('./images/tower-level-2.png'),
  TowerLevel3: new ImageSource('./images/tower-level-3.png'),
...
export const loader = new Loader([
  ...
  Resources.TowerLevel1,
  Resources.TowerLevel2,
  Resources.TowerLevel3,
